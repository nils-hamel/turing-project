...
ml_g_hidden = tf.tanh( tf.add( tf.matmul( ml_g_input, ml_p_w1 ), ml_p_b1 ) )

# network topology : output layer #
ml_g_output = tf.tanh( tf.add( tf.matmul( ml_g_hidden, ml_p_w2 ), ml_p_b2 ) )
...
# network topology : output layer #
ml_s1_output = tf.tanh( tf.add( tf.matmul( ml_s1_input, ml_p_w1 ),ml_p_b1 ) )
