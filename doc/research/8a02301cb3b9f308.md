...
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-geneva-2009.md">64x64x3-geneva-2009</a> data-set</i> and according to the
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-geneva-2009-loss.png?raw=true" width="640">
<br />
...
This sub-section present the training result of the network on the
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-geneva-2011.md">64x64x3-geneva-2011</a> data-set</i> and according to the
size of the network hidden layer. The following plots show
the evolution of the training and validation loss according to
the training epochs. The red curves give the evolution of the training
loss while the orange one shows the evolution of the validation loss.
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-geneva-2011-loss.png?raw=true" width="640">
<br />
...
This sub-section present the training result of the network on the
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-geneva-2016.md">64x64x3-geneva-2016</a> data-set</i> and according to the
size of the network hidden layer. The following plots show
the evolution of the training and validation loss according to
the training epochs. The red curves give the evolution of the training
loss while the orange one shows the evolution of the validation loss.
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-geneva-2016-loss.png?raw=true" width="640">
<br />
...
This sub-section present the training result of the network on the
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-geneva-oblique-2013.md">64x64x3-geneva-oblique-2013</a> data-set</i> and according to the
size of the network hidden layer. The following plots show
the evolution of the training and validation loss according to
the training epochs. The red curves give the evolution of the training
loss while the orange one shows the evolution of the validation loss.
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-geneva-oblique-2013-loss.png?raw=true" width="640">
<br />
...
This sub-section present the training result of the network on the
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-paris-louvre-2017.md">64x64x3-paris-louvre-2017</a> data-set</i> and according to the
size of the network hidden layer. The following plots show
the evolution of the training and validation loss according to
the training epochs. The red curves give the evolution of the training
loss while the orange one shows the evolution of the validation loss.
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-paris-louvre-2017-loss.png?raw=true" width="640">
<br />
...
This sub-section present the training result of the network on the
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-venezia-2004.md">64x64x3-venezia-2004</a> data-set</i> and according to the
size of the network hidden layer. The following plots show
the evolution of the training and validation loss according to
the training epochs. The red curves give the evolution of the training
loss while the orange one shows the evolution of the validation loss.
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-venezia-2004-loss.png?raw=true" width="640">
<br />
...
This sub-section present the training result of the network on the
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-venezia-2010.md">64x64x3-venezia-2010</a> data-set</i> and according to the
size of the network hidden layer. The following plots show
the evolution of the training and validation loss according to
the training epochs. The red curves give the evolution of the training
loss while the orange one shows the evolution of the validation loss.
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-venezia-2010-loss.png?raw=true" width="640">
<br />
...
This sub-section present the training result of the network on the
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-venezia-2014.md">64x64x3-venezia-2014</a> data-set</i> and according to the
size of the network hidden layer. The following plots show
the evolution of the training and validation loss according to
the training epochs. The red curves give the evolution of the training
loss while the orange one shows the evolution of the validation loss.
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-venezia-2014-loss.png?raw=true" width="640">
<br />
...
This sub-section present the training result of the network on the
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-venezia-campanile-2016.md">64x64x3-venezia-campanile-2016</a> data-set</i> and according to the
size of the network hidden layer. The following plots show
the evolution of the training and validation loss according to
the training epochs. The red curves give the evolution of the training
loss while the orange one shows the evolution of the validation loss.
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-venezia-campanile-2016-loss.png?raw=true" width="640">
<br />
...
This sub-section present the training result of the network on the
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-venezia-palazzo-ducale-2016.md">64x64x3-venezia-palazzo-ducale-2016</a> data-set</i> and according to the
size of the network hidden layer. The following plots show
the evolution of the training and validation loss according to
the training epochs. The red curves give the evolution of the training
loss while the orange one shows the evolution of the validation loss.
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-venezia-palazzo-ducale-2016-loss.png?raw=true" width="640">
<br />
...
This sub-section present the training result of the network on the
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-venezia-piazza-2016.md">64x64x3-venezia-piazza-2016</a> data-set</i> and according to the
size of the network hidden layer. The following plots show
the evolution of the training and validation loss according to
the training epochs. The red curves give the evolution of the training
loss while the orange one shows the evolution of the validation loss.
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-venezia-piazza-2016-loss.png?raw=true" width="640">
<br />
...
This sub-section present the training result of the network on the
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-venezia-san-giacometto-2016.md">64x64x3-venezia-san-giacometto-2016</a> data-set</i> and according to the
size of the network hidden layer. The following plots show
the evolution of the training and validation loss according to
the training epochs. The red curves give the evolution of the training
loss while the orange one shows the evolution of the validation loss.
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-venezia-san-giacometto-2016-loss.png?raw=true" width="640">
<br />
...
This sub-section present the training result of the network on the
<a href="https://github.com/nils-hamel/turing-project/blob/master/doc/dataset/64x64x3-venezia-san-marco-2016.md">64x64x3-venezia-san-marco-2016</a> data-set</i> and according to the
size of the network hidden layer. The following plots show
the evolution of the training and validation loss according to
the training epochs. The red curves give the evolution of the training
loss while the orange one shows the evolution of the validation loss.
...
<p align="center">
<img src="https://github.com/nils-hamel/turing-project/blob/master/doc/research/8a02301cb3b9f308/64x64x3-venezia-san-marco-2016-loss.png?raw=true" width="640">
<br />
