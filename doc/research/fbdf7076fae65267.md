## Training and generalisation of the inv-hsv-osi-l2 according to data-sets and hidden layer size
...
The auto-encoder consists in three layers : the input layer that have its
size corresponding to the amount of the data-sets images pixels; the hidden layer that is
...
selected hidden layer sizes. The number of training epochs is always 256.
